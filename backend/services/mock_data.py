...
# grassland, Eastern Province) and Rulindo (agroforestry, Northern
# Province) only — see backend/data/sample_plots.geojson and the revised
# research proposal Section 1.5/3.3.1. Values below are approximate,
# illustrative terrain priors for these two districts (Bugesera: lower,
# flatter, semi-arid plateau; Rulindo: higher, steeper, wetter "thousand
# hills" terrain), not measured data. The fallback default below covers any
# plot whose `region` doesn't match either district (e.g. legacy demo rows).
REGION_ELEVATION = {
    "Bugesera": {"elevation": 1400, "slope": 5, "precip": 900},
    "Rulindo": {"elevation": 1900, "slope": 18, "precip": 1300},
}
