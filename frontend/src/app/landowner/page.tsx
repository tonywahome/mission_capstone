...
function PlotCard({
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      setDeleteError(
        msg.includes("pending verification, verified, listed, or sold")
          ? "This plot has a record that is pending verification or already verified, and cannot be deleted."
    ...
    <div className="min-h-screen bg-[var(--color-surface-subtle)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted mt-1">Satellite monitoring and biomass verification for your plots</p>
        </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-amber-600">Approve to add the result to the audit trail</p>
              </div>
            </div>
          ...
          <div className="lg:col-span-2">
            ...
            {plots.length === 0 ? (
              <div className="bg-white rounded-2xl border border-[var(--color-border)] p-12 text-center shadow-sm">
                ...
                <p className="text-muted mb-6 text-sm">Register your land to start satellite monitoring and biomass estimation.</p>
                <Link
                  href="/request-registration"
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-[var(--color-border)] p-5 shadow-sm">
              ...
              <div className="space-y-1">
                {[
                  { href: "/landowner/pending-scans", icon: "📋", label: "My submissions" },
                  { href: "/request-registration",   icon: "🗺️", label: "Register new project" },
                ].map(a => (
